...
--Caso aconteça erro na Employee:
--Primeiro, insira os registros na tabela employee sem a coluna Super_ssn.
...
--Atualize os registros existentes para adicionar os valores em Super_ssn.
--Após inserir os registros sem Super_ssn, você pode atualizar a tabela para definir os valores corretos para Super_ssn.
UPDATE employee
